...
wrap_import!("sqlite:open" sqlite_open "fermyon:spin/sqlite" "open" a0 a1 a2);

wrap_import!("sqlite:execute" sqlite_execute "fermyon:spin/sqlite" "execute" a0 a1 a2 a3 a4 a5);

wrap_import!("sqlite:close" sqlite_close "fermyon:spin/sqlite" "close" a0);
...
wrap_import_llm_infer!("llm:infer" llm_infer "fermyon:spin/llm" "infer");

wrap_import!("llm:generate-embeddings" llm_generate_embeddings "fermyon:spin/llm" "generate-embeddings" a0 a1 a2 a3 a4);
