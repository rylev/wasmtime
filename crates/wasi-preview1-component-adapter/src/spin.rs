...
wrap_import!("llm:infer" llm_infer "fermyon:spin/llm" "infer" a0: i32 a1: i32 a2: i32 a3: i32 a4: i32 a5: i32 a6: f32 a7: i32 a8: f32 a9: i32 a10: f32 a11: i32);

wrap_import!("llm:generate-embeddings" llm_generate_embeddings "fermyon:spin/llm" "generate-embeddings" a0:i32 a1:i32 a2:i32 a3:i32 a4:i32);
